...
{
    public $alias = "医生";
    protected $fields = array("id" => "工号", "name" => "姓名", "phone" => "电话", "c_dept" => "所属门诊科室");
    protected $textFields = array("id" => "工号", "name" => "姓名", "phone" => "电话");
    protected $optFields = array("sex" => "性别" , "title" => "职称", "c_deptId", "所属门诊科室");

    public function prepareRows()
    {
        $m = model("doctor");
        $rows = $m->with("clinic_department")->all()->bindAttr("clinic_department",["c_dept" => "name"]);
        return $rows;
    }
